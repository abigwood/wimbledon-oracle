...
class WimbledonOracleTests(unittest.TestCase):
    ...
    def test_html_asset_versions_match(self):
        ...
        self.assertIn("styles.css?v=20260629c", html)
        self.assertIn("app.js?v=20260629c", html)
    ...
    def test_service_worker_updates_app_shell_network_first(self):
        ...
        app = (ROOT / "app.js").read_text()
        self.assertIn("wimbledon-oracle-v21-20260629", sw)
        self.assertIn("styles.css?v=20260629c", sw)
        self.assertIn("app.js?v=20260629c", sw)
