const CACHE = "wimbledon-oracle-v24-20260629";
const ASSETS = ["./", "index.html", "reset-cache.html", "styles.css?v=20260629f", "app.js?v=20260629f", "data/fixtures.json", "icon.svg", "icons/icon-192.png", "icons/icon-512.png", "icons/apple-touch-icon.png", "manifest.webmanifest"];
